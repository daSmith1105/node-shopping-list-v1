...
Recipes.create('beef stew', ['beef', 'potatos', 'celery', 'carrots', 'broth']);
Recipes.create('spagetti', ['pasta', 'tomato sauce', 'beef']);
Recipes.create('chocolate chip cookies', ['cookie dough', 'chocolate chips']);
